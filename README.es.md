...
<p align="center">
  <a href="#características"><img style="border-radius: 8px;" src="https://img.shields.io/badge/📦_Características-blue?style=for-the-badge" alt="Características"></a>
  <a href="#limitaciones"><img style="border-radius: 8px;" src="https://img.shields.io/badge/⚠️_Limitaciones-orange?style=for-the-badge" alt="Limitaciones"></a>
  <a href="#requisitos-previos"><img style="border-radius: 8px;" src="https://img.shields.io/badge/⚙️_Requisitos-gray?style=for-the-badge" alt="Requisitos"></a>
  <a href="#demo-en-vivo"><img style="border-radius: 8px;" src="https://img.shields.io/badge/🚀_Demo_en_Vivo-green?style=for-the-badge" alt="Demo en Vivo"></a>
</p>
  ...
  <tr>
    ...
    <td width="80%" valign="middle" align="center">
      ...
      >
        ...
        <tr>
          <td style="padding:10px 12px; border-bottom:1px solid rgba(127,127,127,.18); white-space:nowrap;">
            📚 <strong>Todos los Elementos</strong>
          </td>
          <td style="padding:10px 12px; border-bottom:1px solid rgba(127,127,127,.18);">
        ...
        <tr>
          <td style="padding:10px 12px; white-space:nowrap;">
            ⚙️ <strong>Gestor de Servicios</strong>
          </td>
...
>
  ...
  <tr>
    <td align="center" style="padding:10px 12px; border-bottom:1px solid rgba(127,127,127,.18); white-space:nowrap;">
      <strong>Imagen Rápida de Snippet</strong>
    </td>
    <td align="center" style="padding:10px 12px; border-bottom:1px solid rgba(127,127,127,.18);">
  ...
  <tr>
    ...
    <td width="40%" valign="center">
      ...
      >
        ...
        <tr>
          <td style="padding:10px 12px; border-bottom:1px solid rgba(127,127,127,.18); white-space:nowrap;">
            ✨ <strong>Tinte de Ventana</strong>
          </td>
          <td style="padding:10px 12px; border-bottom:1px solid rgba(127,127,127,.18);">
        ...
        <tr>
          <td style="padding:10px 12px; white-space:nowrap;">
            🔢 <strong>Límite de Recientes</strong>
          </td>
          <td style="padding:10px 12px;">
    ...
    <td width="34%" valign="middle" align="center">
      <a href="https://yeraylois.github.io/localsnips-preview/">
        <img
          ...
          src="https://img.shields.io/badge/🌐_Abrir_Vista_Previa-0066FF?style=for-the-badge&logoColor=white"
          alt="Abrir Vista Previa"
        >
      </a>
      <br>
